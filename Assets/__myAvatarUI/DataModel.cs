...
public class DataModel   
{
   static DataModel _model;
    ...
    public void RemoveBook(BookModel model)//去除按钮
    {
        BookList.Remove(model);
    }
    public void RemoveRemainTime(ClockModel model)//去除按钮
    {
        RemainTime.Remove(model);
    }
    public void UpdateBook(BookModel model)//不需要
    {
...
public class DayTime//calculating time
{
    public int hour;
    public int minute;
    ...
    public string GetString()//生成string的代码
    {
